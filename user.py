...
class User:
    ...
    def from_form(self, name, phone_number, custom_paths, is_la, group):
        self.details = {
    ...
    def group_dict(self):
        self.get_details().get("group", {})

    def group_value(self):
        return self.get_details().get("group", {}).get("value", "")

    def is_la(self):
        return True if self.get_details().get("custom:is_la", "0") == "1" else False
    ...
    def update(self, name, phone_number, custom_paths, is_la, group):
        ...
        try:
            ...
            print("name ok")
            attrs += self.__custom_path_attribute(custom_paths, group)
            print("path ok")
    ...
    def __custom_path_attribute(self, custom_paths, group_name):
        ...
        if isinstance(custom_paths, str):
            group_name = (
                ...
                else self.details["group"]["value"]
            )
            if not self.user_paths_are_valid(custom_paths, group_name):
    ...
    def user_paths_are_valid(self, paths_semicolon_separated, group_name):
        ...
        for authorised_path in app_authorised_paths:
            for path in paths_semicolon_separated.split(";"):
                ...
                if self.details["custom:is_la"] == "0":
                ...
                if self.details["custom:is_la"] == "1":
    ...
    def __phone_number_attribute(self, phone_number):
        ...
        if sanitised_phone == self.details["phone_number"]:
            ...
            return phone_attribute + [{"Name": "phone_number_verified", "Value": "false"}]
